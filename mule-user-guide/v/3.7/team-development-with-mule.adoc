...
URL IS BROKEN, CAN'T FIND THE DOC ANYWHERE?
link:/documentation/download/attachments/122751378/Team+Development+with+Mule.pdf?version=1&modificationDate=1303431731496[here].
