...
|API Versions Owner | An API Versions Owner can manage, delete, and deprecate any API in the organization. +
They can edit the portal of any API in the organization.
...
|Exchange Administrators | Manage Exchange Portal customization, manage assets, manage reviews.
|Exchange Contributors | Contribute Exchange assets and manage versions.
|Exchange Viewers | View and consume Exchange assets.
|===
